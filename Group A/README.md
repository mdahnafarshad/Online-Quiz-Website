...
After completing the quiz, the student will be able to view the result and visit a personal
profile dashboard where detailed information will be displayed.
...
● To allow authenticated users to participate in quizzes
● To display quiz results instantly after submission
● To provide a profile dashboard containing student details and performance
information
...
The system will mainly focus on student interaction with the quiz platform. It will ensure
that only registered and logged-in users can access quiz participation features.
